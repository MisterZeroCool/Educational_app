...
class QuestionAdapter(private val dataSet: ArrayList<Question>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.option1.text = dataSet[position].operator1
        holder.option2.text = dataSet[position].operator2
        holder.option3.text = dataSet[position].operator3
        holder.option4.text = dataSet[position].operator4
