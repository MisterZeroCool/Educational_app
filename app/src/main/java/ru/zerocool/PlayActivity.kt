...
import ru.zerocool.databinding.ActivityPlayBinding
...
class PlayActivity : AppCompatActivity() {
    ...
    private fun updateOption() {
        binding?.btnOption1?.text = questionDataList[position].operator1
        binding?.btnOption2?.text = questionDataList[position].operator2
        binding?.btnOption3?.text = questionDataList[position].operator3
        binding?.btnOption4?.text = questionDataList[position].operator4
    }
    ...
    private fun startTimer() {
        ...
        binding?.circularProgressBar?.max = count
